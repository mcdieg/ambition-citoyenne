    ...
    <section className="section">
      <div className="container">
        ...
        <img src={underconstruction} alt="collectif citoyen" style={{ width: '350px', height: '350px' }} />
          ...
          <h2>Mettre en selle le plan vélo </h2>
          <p>
          ...
          <h2>Donner sa place à notre jeunesse</h2> 
          <p>
          ...
          <h2>Intégrer l’urgence climatique</h2> 
          <p>
          ...
          <h2>Remettre à plat le budget</h2>
          <p>
          ...
          <h2>Construire une ville mixte</h2>
          <p>
            ...
            JF PAPOT, B MAUBRAS,C LEROY, C FAGUETTE
            Permanences : le samedi matin au 45 avenue Herriot ou le dimanche matin au marché – hors congés
          </p>
        </div>
      </div>
    </section>
